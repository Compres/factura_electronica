...
function facelec_sales_taxes_charges_row(frm, cdt, cdn) {
    ...
    frm.doc.items.forEach(function (item_row_i, index_i) {
        if (item_row_i.name == cdn) {
            ...
            if (cuenta !== null) {
                console.log("NUEVA: La cuenta se detecto en Items: " + cuenta);
                if (buscar_account(frm, cuenta)) {
                    ...
                    if (otro_impuesto == 0) {} else {}

                    frm.doc.taxes.forEach(function (tax_row, index) {
                        if (tax_row.account_head == cuenta) {
                            ...
                            frappe.call({
                                ...
                                callback: function callback(data) {
                                    ...
                                    frm.doc.taxes[index].rate = otro_impuesto / (valor_con_iva / (1 + 12));
